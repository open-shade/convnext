...
if not ALGO_VERSION:
    ALGO_VERSION = 'facebook/convnext-base-224'


def predict(image: Image):
    feature_extractor = ConvNextFeatureExtractor.from_pretrained(ALGO_VERSION)
    model = ConvNextForImageClassification.from_pretrained(ALGO_VERSION)
